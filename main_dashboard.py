...
class MainDashBoard:
    def __init__(self, root):
        ...
        self.Title = tk.Label(self.frame,bg=MAIN_BG , text=" DashBoard",font=("Arial",30),fg='white')
        self.Title.pack(side=tk.LEFT)
        self.current_dashboard = tk.Label(self.frame,bg=MAIN_BG , text=self.current,font=("Arial",13),fg='white')
